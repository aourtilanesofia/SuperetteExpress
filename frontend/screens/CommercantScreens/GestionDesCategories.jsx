...
const GestionDesCategories = () => {
    ...
    const fetchCategories = async () => {
        try {
            ...
            const response = await fetch('http://192.168.1.36:8080/api/categories');
                ...
                { text: "Annuler", style: "cancel" },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            await fetch(`http://192.168.1.36:8080/api/categories/delete/${id}`, { method: 'DELETE' });
                ...
                renderItem={({ item }) => (
                    <View style={styles.categoryItem}>
                        ...
                        <Image 
                            ...
                            source={{ uri: item.image.startsWith('http') ? item.image : `http://192.168.1.36:8080${item.image}` }} 

...
const AcceuilAdmin = ({ navigation }) => {
  ...
  useEffect(() => {
    fetch("http://192.168.1.38:8080/api/v1/commercant/count")
  ...
  useEffect(() => {
    fetch("http://192.168.1.38:8080/api/v1/consommateur/activeConsommateurs/count")
      .then(response => response.json())
      .then(data => {
  ...
  useEffect(() => {
    fetch("http://192.168.1.38:8080/api/v1/consommateur/nonactiveConsommateurs/count")
      .then(response => response.json())
      .then(data => {
        //console.log("Réponse reçue :", data);
        if (data.success) {
  ...
  useEffect(() => {
    fetch("http://192.168.1.38:8080/api/v1/livreur/count")
      .then(response => response.json())
      .then(data => {
        if (data.success) {

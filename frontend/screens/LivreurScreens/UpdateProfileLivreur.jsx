...
const UpdateProfileLivreur = ({ navigation }) => {
    ...
    const getAbsoluteUrl = (path) => {
        ...
        return `http://192.168.1.36:8080${path}`;
    ...
    const uploadImage = async (uri) => {
        console.log("Tentative de connexion à :", `http://192.168.1.36:8080`);

        try {
            // Test préalable de la connexion
            await fetch(`http://192.168.1.36:8080`, { method: 'HEAD' });
            ...
            const response = await fetch(`http://192.168.1.36:8080/api/v1/livreur/upload-profile-pic`, {
                method: 'POST',
                headers: {
    ...
    try {
        ...
        const response = await fetch('http://192.168.1.36:8080/api/v1/livreur/profile-updateL', {
            method: 'PUT',
            headers: {

    ...
    {/*formulaire*/}
      ...
      <View style={styles.inputContainer}>
        ...
        <View style={styles.inputContainer}>
            ...
            <TextInput style={styles.textInput} placeholder='Entrez la catégorie de votre véhicule' keyboardType='email-address'/>
        </View>

        <View style={styles.inputContainer}>
            <Octicons name='number' size={22} color={'#939494'}/>
            <TextInput style={styles.textInput} placeholder='Entrez votre matricule' keyboardType='email-address'/>
        </View>

      ...
      <ScrollView style={styles.container}>
        ...
        >
          <View style={styles.optionContent}>
            ...
            <View style={styles.optionTextContainer}>
              <Text style={styles.optionLabel}>Options de livraison</Text>
        ...
        >
          <View style={styles.optionContent}>
            ...
            <View style={styles.optionTextContainer}>
              <Text style={styles.optionLabel}>Infos destinataire</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.facturationCard}>
            <View style={styles.facturationRow}>
              <Text style={styles.facturationLabel}>Sous-total</Text>
              <Text style={styles.facturationValue}>{commande.total}.00 DA</Text>
            </View>
            <View style={styles.facturationRow}>
              <Text style={styles.facturationLabel}>Livraison</Text>
        ...
        >
          <View style={styles.modalContainer}>
            ...
            {activeModal === 'adresse' && (
              <>
                ...
                >
                  ...
                  <Text style={styles.modalOptionText}>Sélectionner sur la carte</Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text style={styles.modalOptionText}>Saisir l'adresse manuellement</Text>
                </TouchableOpacity>
                ...
                <View style={styles.modalButtons}>
                  ...
                  >
                    <Text style={styles.confirmButtonText}>Enregistrer l'adresse</Text>
                  </TouchableOpacity>
                </View>
              </>
            )}
            ...
            {activeModal === 'options' && (
              <>
                <Text style={styles.modalTitle}>Information supplémentaire</Text>
                ...
                <Text style={{ fontSize: 16, fontWeight: '600', marginTop: 10 }}>
                  Ajoutez tout autre détail supplémentaire que vous trouvez utile pour localiser l'adresse.
                </Text>
            ...
            {activeModal === 'destinataire' && (
              <>
                ...
                <Text style={{ fontSize: 16, fontWeight: '600', marginBottom: 10 }}>
                  Le livreur les utilisera pour vous vous contacter.
                </Text>
                ...
                <View style={styles.modalButtons}>
                  ...
                  >
                    <Text style={styles.confirmButtonText}>Confirmer les informations</Text>
                  </TouchableOpacity>
                </View>
              </>
            )}
